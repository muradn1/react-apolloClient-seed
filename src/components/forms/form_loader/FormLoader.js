...
import {
  openFormService,
  saveClickedService,
  deleteClickedService
} from "./formLoaderService";
...
function FormLoader({ history }) {
  ...
  const [formToLoad, setFormToLoad] = useState(() =>
    chooseFormToLoadByPathName(history.location.pathname)
  );
  ...
  return (
    <Draggable handle="strong">
      <div className="form-loader box no-cursor">
        <strong className="cursor">
          <div className="header">
            ...
            >
              <MenuItem
                style={menuItemStyle}
                onClick={() => deleteClickedService.deleteClicked()}
              >
                מחק
              </MenuItem>
              <MenuItem style={menuItemStyle} onClick={closeForm}>
                סגור
              </MenuItem>
            </Menu>
          </div>
        ...
        <div className="my-form">{formToLoad(entityId)}</div>

        <Button
          onClick={() => saveClickedService.saveClicked()}
          variant="contained"
          size="small"
